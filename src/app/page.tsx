    ...
    <main className={styles.main}>
      ...
      <div className={styles.grid}>
        <Card>
          ...
          <p>This is a complete rewrite of my personal website for 2025. It's built using NextJS (React), CI/CD with Github and Vercel, and Jest for testing.</p>
          <p>Feel free to check out my other recent projects <Link href="/projects">here</Link></p>
        </Card>
        ...
        <Card>
          ...
          <div className={styles.buttonRow}>
            ...
            <Button href="/projects" level={2}>Secondary</Button>
          </div>
        </Card>
      </div>
    </main>
