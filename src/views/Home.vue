<template>
    <v-container>
        ...
        <v-row class="interest-row">
            <v-col cols="2"><h3><router-link :to="`/development`">Developer</router-link></h3></v-col>
        ...
        <v-row class="interest-row">
            <v-col cols="2"><h3><router-link :to="`/music`">Musician</router-link></h3></v-col>
            <v-col style="text-align: left">
        ...
        <v-row class="interest-row">
            <v-col cols="2"><h3><router-link :to="`/research`">Researcher</router-link></h3></v-col>
            <v-col style="text-align: left">
        ...
        <v-row class="interest-row">
            <v-col cols="2"><h3><router-link :to="`/trampolining`">Trampolinist</router-link></h3></v-col>
            <v-col style="text-align: left">
